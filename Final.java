...
public class Final {
  ...
  public void setAutomaticRifle(Boolean automaticRifle) {
  ...
  public void setFastRecover(Boolean fastRecover) {
  ...
  public void setSpyID(Boolean spyID) {
    this.spyID = spyID;
  }
  ...
  public void setTryEscape(Boolean tryEscape) {
    TryEscape = tryEscape;
  }
  ...
  public void setPlayerInventory(ArrayList<Object> playerInventory) {
  ...
  //creates a hashmap. Integer will be the key and then there is a list for all the other integers and boolean values
  ...
  // ^ what we will put into array list
 ...
 */
  ...
  //creates a badgevalue to save in GAMEGUI becuse getBadge requires an input
  public boolean getBadgeValue(){
    return this.Badge;

  }

  public  boolean getTryEscape(){
  ...
  public void Introduction() {
    ...
    this.Delay();
    System.out.printf("You may catch a serious disease when you enter some untidy places. This status can be cured by using one unit of medicine.%nIf you do not do it or run out of medicine, then you cannot recover HP and will lose 5HP every day.%n To save, put in your name and click save. To load, follow the same steps but click load.%nThe concludes the tutorial. Good Luck!!%n%n%n%n");
  }
  ...
  // creates a save file for the key and value the player has
  public void createSaveFile(String key, ArrayList<Object> playerInventory) {
    //Collections.addAll(playerInventory,key, CurrentCoordinate, day,hp,food,pistol,AutomaticRifle,ammo,medicine,bandage,valuables,Moral,sick,hungry,FastRecover,injured,spyID,Cipher,Badge,TryEscape);
    savedFile.put(key, playerInventory);
  }

  public HashMap getSavedFile(){
    //creates the key 0 for a new game save file so that a new game always exists when trying to load
    int[] start = {14,0};
    ArrayList<Object> inv = new ArrayList<Object>();
    Collections.addAll(inv, start, 1, 100, 10, false, false, 0, 5, 3, 2, 100, false, 10 , false, false, false, false, false, false);
    savedFile.put("0",inv);
